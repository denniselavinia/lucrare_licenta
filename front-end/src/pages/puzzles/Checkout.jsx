        ...
        <section>
            <div className="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
                <div className="container max-w-screen-lg mx-auto">
                    <div>
                        <div>
                            <h2 className="font-semibold text-xl text-gray-600 mb-2">Plată cash la livrare</h2>
                            <p className="text-gray-500 mb-2">Preț total: {totalPrice} RON</p>
                            <p className="text-gray-500 mb-6">Număr produse : {cartItems.length}</p>
                        </div>

                        <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                            <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3 my-8">
                                <div className="text-gray-600">
                                    <p className="font-medium text-lg">Date de facturare și livrare</p>
                                </div>
                                        ...
                                        <div className="md:col-span-5">
                                            ...
                                            <input
                                                ...
                                                {...register("phone", {
                                                    ...
                                                    pattern: {
                                                        value: /^0\d{9}$/,
                                                        message: "Introduceți un număr valid (ex: 07xxxxxxxx)"
                                                    }
                                                })}
                                            />
                                            {errors.phone && (
                                        ...
                                        <div className="md:col-span-5 flex flex-col md:flex-row gap-4">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <input
                                                    ...
                                                    className="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                                                    autoComplete="off"
                                                    {...register("country", { required: "Județul este obligatoriu" })}
                                                />
                                                <datalist id="judete">
                                                    <option value="Alba" />
                                                    <option value="Arad" />
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <input
                                                    ...
                                                    className="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                                                    placeholder=""
                                                    {...register("zipcode", { required: "Codul poștal este obligatoriu" })}
                                                />
                                                {errors.zipcode && (
