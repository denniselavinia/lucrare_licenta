...
const Sells = () => {
    ...
    const { data: sells = [], isLoading, isError } = useGetSellByEmailQuery(currentUser.email);
                    ...
                    <div>
                        {sells.map((sell, index) => (
                            <div key={sell._id || index} className="border-b mb-4 pb-4">
                                ...
                                <p className="font-semibold">Descriere puzzle: {sell.description}</p>
                                <p className="font-semibold">Număr de piese puzzle: {sell.noPieces}</p>
                                <p className="font-semibold">Categorie puzzle: {sell.categoryImage}</p>
                                <p className="font-semibold">Brand puzzle: {sell.categoryManufacturer}</p>
