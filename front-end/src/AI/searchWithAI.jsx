...
${puzzles
	.map(
		(
			p
		) => `Title: ${p.title}, Description: ${p.description}, Number of pieces: ${p.noPieces}, Image category: ${p.categoryImage}, 
    Manufacturer/Brand: ${p.categoryManufacturer}, Price: ${p.price}`
	)
	.join("\n")}
...
`;
	...
	return (
		<div
			className="fixed bottom-4 right-4 z-50 px-12 py-8 flex flex-col-reverse items-end"
			title="Asistent Puzzle"
		>
			{open && (
				<div
